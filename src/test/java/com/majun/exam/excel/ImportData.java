...
public class ImportData {
    ...
    public void importData() throws Exception {
      /* List<User> users =  userMapper.selectAll();
        ...
        List<ExcelData> datas = readXml("src/test/resources/data.xls");
        saveDatas(datas);
    }
    ...
    private List<ExcelData> readXml(String path) throws Exception {
        ...
        for (int rowNum = 1; rowNum <= hssfSheet.getLastRowNum(); rowNum++) {
            ...
            data.setOptionA(getStringVal(hssfRow.getCell(5)));
            data.setOptionB(getStringVal(hssfRow.getCell(6)));
            data.setOptionC(getStringVal(hssfRow.getCell(7)));
            data.setRightAnswer(getStringVal(hssfRow.getCell(2)));
